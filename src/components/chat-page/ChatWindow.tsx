...
export function ChatWindow({ onScrollDirectionChange }: ChatWindowProps) {
  ...
  // Проверка на переполненность чата (50 сообщений)
  ...
  useEffect(() => {
    const fetchNewMessage = async () => {
      ...
      try {
        ...
        // Сбрасываем флаги ожидания после получения сообщения
  ...
  // Автоматический скролл при изменении сообщений или анимации ожидания
  useEffect(() => {
